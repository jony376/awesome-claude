/**
 * Pure npm package spec parsing helpers.
 *
 * Parses scoped and unscoped package names with optional exact semver pins.
 * Nothing here touches the network — given the same spec string the output is
 * deterministic.
 *
 * The public surface (`package-spec.js` / `@heyclaude/registry/package-spec`)
