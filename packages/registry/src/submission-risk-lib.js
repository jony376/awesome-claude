/**
 * Pure submission risk analysis helpers.
 *
 * Draft and direct-content risk scoring, request-changes reasons, and markdown
 * report formatting live here. Nothing touches the network — given the same
 * submission payload the output is deterministic.
 *
 * The public surface (`submission-risk.js` / `@heyclaude/registry/submission-risk`)
