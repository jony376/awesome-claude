/**
 * MCP tool input schema surface.
 *
 * Pure Zod schemas and JSON-schema helpers live in `schemas-lib.js`. This
 * module re-exports that surface so existing `./schemas.js` imports stay
 * unchanged.
 */
export {
