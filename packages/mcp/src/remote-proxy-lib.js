/**
 * Pure MCP remote proxy helpers.
 *
 * Streamable HTTP proxy wiring, read-only tool filtering, local draft tool
 * blocking, and timeout fetch behavior live here. Network I/O stays in the
 * caller-provided MCP client transport.
 *
 * The public surface (`remote-proxy.js` / `@heyclaude/mcp/remote-proxy`)
