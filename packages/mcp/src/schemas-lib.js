/**
 * Pure MCP tool input schemas.
 *
 * Zod schemas, JSON-schema conversion, argument parsing, and error formatting
 * live here. Nothing touches the network — given the same tool name and args
 * the output is deterministic.
 *
 * The public surface (`schemas.js`) re-exports everything below so existing
 * MCP imports stay unchanged.
 */
import { z } from "zod";
