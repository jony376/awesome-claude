/**
 * Pure MCP stdio server wiring helpers.
 *
 * SDK server construction and request handler registration live here. The
 * public surface (`server.js`) re-exports everything below so existing imports
 * stay unchanged.
 */
