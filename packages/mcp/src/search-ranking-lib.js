/**
 * Pure MCP registry search ranking helpers.
 *
 * Query normalization, alias expansion, platform matching, trust-weighted
 * intent scoring, and ranked search results live here. Nothing touches the
 * network — given the same entry list and query the output is deterministic.
 *
 * The public surface (`search-ranking.js` / `@heyclaude/mcp/search-ranking`)
