/**
 * Pure MCP CLI option parsing helpers.
 *
 * Argument parsing and help text generation live here. The CLI entrypoint
 * (`cli-options.js` / `@heyclaude/mcp/cli-options`) re-exports this surface
 * so existing imports stay unchanged.
 */
import {
